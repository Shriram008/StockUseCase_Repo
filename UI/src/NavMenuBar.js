...
class NavMenuBar extends Component {
  ...
  <Button variant="outline-primary" href="/charts" >Profile DashBoard</Button>
  <Button variant="outline-primary" href="/signup">Create Profile</Button>
...
<Button variant="outline-primary" href="/Stock/view">Add Stock</Button>
<Button variant="outline-primary" href="/Stock/buy">Add Stock</Button>
<Button variant="outline-primary" href="/Stock/update">Add Stock</Button>
